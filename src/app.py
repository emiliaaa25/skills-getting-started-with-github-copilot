...
activities = {
    ...
    "Swimming Club": {
        "description": "Build endurance and improve swimming techniques",
    ...
    "Science Club": {
        "description": "Discover experiments, projects, and scientific problem solving",
    ...
    "Debate Team": {
        ...
        "max_participants": 12,
        "participants": ["scarlett@mergington.edu", "henry@mergington.edu"]
    }
}
